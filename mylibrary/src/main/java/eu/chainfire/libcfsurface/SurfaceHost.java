...
public  class SurfaceHost {
 /*   public static String getLaunchString(Context context, Class<?> clazz, String app_process, String niceName) {
    ...
    public static volatile boolean mShow = true;
    public static  volatile boolean mIsVisible = false;
    public static volatile int mWidth = 0;
    public static volatile int mHeight = 0;
    public static volatile int fallbackWidth = 0;
    public static  volatile int fallbackHeight = 0;
    public static volatile long mLastFrame = 0;
    public static volatile String mAPK = null;
    public static volatile Context mContext = null;
    public static volatile DisplayManager mDisplayManager = null;
    public static volatile int mLastRotation = Surface.ROTATION_0;

    public Object mSurfaceSession = null;
    public Class<?> cSurfaceControl = null;
    public Object mSurfaceControl = null;
    public Method mSurfaceControlOpenTransaction = null;
    public Method mSurfaceControlCloseTransaction = null;
    public Method mSurfaceControlSetLayer = null;
    public Method mSurfaceControlShow = null;
    public Method mSurfaceControlHide = null;
    public Method mSurfaceControlSetSize = null;
    public Surface mSurface = null;
    public Method mSurfaceControlGetGlobalTransaction = null;
    public Object mTransaction = null;
    public Method mTransactionApply = null;
    public Method mTransactionShow = null;
    public Method mTransactionHide = null;
    public Method mTransactionSetLayer = null;
    public Method mTransactionSetBufferSize = null;
    ...
    public final boolean initSurface() {
        ...
        try {
            ...
            if (mSurfaceControl == null) {
                ...
                for (Constructor<?> constructor : constructors) {
                 ...
                 //   Log.d("constructor[%d]: %s", index, sb.toString());
                    index++;
                }
    ...
    public final void updateSurfaceVisibility() {
        if (mShow != mIsVisible) {
            try {
                mSurfaceControlOpenTransaction.invoke(null);
                if (mTransaction != null) {
   ...
   /* public final void run(String[] args) {
    ...
    protected void onResize(int width, int height) // surface contents may be lost!
    {
